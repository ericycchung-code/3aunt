...
const Menu = () => {
  const items = [
    { id: 'm1', name: '將燒梅花豬便當', desc: '溫潤香氣，微辛回甘', price: '95up', img: "/p2.jpg" },
...
    { id: 'm5', name: '檸香烤雞腿便當', desc: '檸香清爽，肉質鮮嫩', price: '100up', img: '/p2.jpg' },
    { id: 'm6', name: '香煎虱目魚便當', desc: '海風氣息，酥香撲鼻', price: '150up', img: '/p2.jpg' },
    { id: 'm7', name: '私房特餐', desc: '隱藏美味，每日新鮮', price: '100up', img: '/p2.jpg' },
    { id: 'm8', name: '經濟特餐', desc: '香辣迷人，樸實飽滿', price: '60up', img: '/p2.jpg' },
    { id: 'm9', name: '素食便當', desc: '清新香氣，層次分明', price: '90up', img: '/p2.jpg' },
...
      >
        <Pill>到店自取</Pill>
        <h3 className="text-2xl md:text-4xl font-semibold text-zinc-900">
          嘉義縣太保市 · 三姑姑健康屋
        </h3>
